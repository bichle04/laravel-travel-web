                            ...
                            <div class="special-info">
                                ...
                                <div class="row">
                                    <div class="special__price">
                                        ...
                                        <div class="col l-4 m-4 c-5">
                                            <span class="special__current-price" id="price_adult" style="margin-left: auto; color: #1bbc9b;">
                                ...
                                <div class="row">
                                    <div class="special__price">
                                        ...
                                        <div class="col l-4 m-4 c-5">
                                            <span class="special__current-price" id="price_child" style="margin-left: auto; color: #1bbc9b;">
                                                0
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="special__price" style="border-top: 1px solid; padding-top: 15px; margin-top: 10px">
                                    <span class="special__price-unit" style="font-weight: bold">Tổng tiền: </span>
                                    <span class="special__current-price" id="totalAll" style="margin-left: auto; color: var(--red-color); font-weight: bold">
                                        {{ $tour->price_child }}
                                    </span>
                        ...
                        <div class="col l-6 l-o-1 m-12 c-12">
                            <div class="special__img-wrap">
                                <div class="special__img">
                                    <h3 class="special__heading" style="max-width: 500px">
